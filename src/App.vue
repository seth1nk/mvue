  ...
  <aside class="right-panel">
    ...
    <nav class="nav-buttons">
      <ul class="button-list">
        ...
        <li v-if="isAuthenticated && role === 'admin'"><a href="https://mnode.onrender.com" class="admin-button">Админ-панель</a></li>
      </ul>
    </nav>
  </aside>
</template>
...
export default {
  ...
  methods: {
    async checkAuth() {
      try {
        const response = await fetch('https://mnode.onrender.com/auth/check', {
          method: 'GET',
          credentials: 'include',
        });
    ...
    async logout() {
      try {
        const response = await fetch('https://mnode.onrender.com/auth/logout', {
          method: 'GET',
          credentials: 'include',
        });
